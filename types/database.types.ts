...
export type OptionTypeInsert = Database['public']['Tables']['option_types']['Insert']
export type OptionTypeUpdate = Database['public']['Tables']['option_types']['Update']
...
export type PlatOptionInsert = Database['public']['Tables']['plat_options']['Insert']
